      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enterprise compliance metrics</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>SOC 2 Compliance</span>
                <span>{metrics.complianceMetrics.soc2Compliance}%</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span>{metrics.complianceMetrics.iso27001Compliance}%</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span>{metrics.complianceMetrics.gdprCompliance}%</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span>{metrics.complianceMetrics.hipaaCompliance}%</span>
              </div>
                  ...
                  <Alert key={alert.id} variant={getAlertVariant(alert.type)}>
                    ...
                    <AlertDescription>
                      ...
                      <div className="text-xs mt-1">
                        {alert.timestamp.toLocaleTimeString()} • Severity: {alert.severity}/3
                      </div>
                    </AlertDescription>
                  </Alert>
                )
